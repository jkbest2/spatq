...
pars <- list(beta_n = pars_gen$beta_n,
             ...
             epsilon1_n = matrix(0.0, nrow = mesh$n, ncol = n_years - 1),
             epsilon1_w = matrix(0.0, nrow = mesh$n, ncol = n_years - 1),
             ...
             psi1_n = matrix(0.0, nrow = mesh$n, ncol = n_years - 1),
             psi1_w = matrix(0.0, nrow = mesh$n, ncol = n_years - 1),
             log_xi = rep(0.0, 4L),

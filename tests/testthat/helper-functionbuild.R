...
twf_estd <- specify_estimated(
  beta = TRUE, lambda = TRUE,
  obs_lik = 1L
)
twf_setup <- spatq_simsetup(
  study = "qdevscaling",
  repl = 1,
  opmod = 6,
  root_dir = normalizePath(
